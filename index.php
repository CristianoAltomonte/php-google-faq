...
$faq = [
    ...
    [
        ...
        "answer"   => [
            ...
            '<ol></li><li type="a">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.',
            '</li><li type="a">Google LLC, con sede negli Stati Uniti, per il resto del mondo.',
            '</li></ol><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.',
            '</li></ol> ',
...
foreach ($faq as $array) {

    echo "<h2>" .  $array['question'] . "</h2>";

    foreach ($array['answer'] as $answer) {
